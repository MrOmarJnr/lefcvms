...
<head>
  ...
  <title>LEF CVMS | Between Dates Reports</title>
      ...
      <div class="main-content">
        <div class="container-fluid py-4">
          ...
          <div class="dashboard-header">
            <h3><i class="fa-solid fa-chart-line me-2"></i>Generate Visitor Reports by Date</h3>
            ...
            <div class="col-lg-6">
              <div class="card p-3">
                <div class="card-header">
                  <i class="fa-solid fa-calendar-days me-2 text-primary"></i>Select Date Range
                </div>
                <div class="card-body">
                  <form method="post" action="bwdates-reports-details.php" class="form-horizontal">
                    <div class="mb-3">
